...
figure(1);
hold on;
[mean(s_prompt) mean(s_cal_air_down) mean(s_cal_snow_down)]
...
p1 = 10*log10(p1)+distance_factor+30;
p2 = 10*log10(p2)+atten_3dB+30.0;
p3 = 10*log10(p3)+atten_20dB+atten_3dB+30.0;
...
%~ L = legend('Calibration (Air)','Calibration (Snow)','location','south');
FL = findall(L,'-property','linewidth');
set(FL,'linewidth',linewc2);
set(gca,'tickLength',[0.025 0.025]);

%The saved graph.
print -dpdf 'March20_plot1.pdf'
