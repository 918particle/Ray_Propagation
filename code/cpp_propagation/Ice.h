...
class Ice
{
	...
	std::vector<float> _indexVsDepth; //index of refraction for RF frequencies vs. depth in meters
	std::vector<float> _attenuationLengthVsDepth; //attenuation length in meters vs. depth in meters
