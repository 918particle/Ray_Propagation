...
class Ice
{
	public:
		...
		float _sigma; //Radians
		float _scatterLength; //No units because it's number of steps before scattering
		...
		float _C; //Index parameter C, units of 1/meters because it's the compactification rate times g times a density
