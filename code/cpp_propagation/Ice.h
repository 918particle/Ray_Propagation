...
{
	public:
	Ice() : _dimensions(std::pair<float,float>(1000.0,-1000.0)), _useIndexFit(true), _useAttenuationLengthFit(true), _A(1.78), _B(0.427), _C(0.014) {};
	...
	void CreateIce(std::pair<float,float>,bool,bool,std::string = "");
