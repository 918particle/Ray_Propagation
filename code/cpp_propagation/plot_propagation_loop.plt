...
set title "Index: Fit to South Pole. [20.0,30.0] deg in 0.5 deg steps." font "Courier,18"
set lmargin 14.0
set rmargin 9.0
set bmargin 7.0
set tmargin 3.0
...
set output "May18_plot6_testSurfaceTransmission.eps"
