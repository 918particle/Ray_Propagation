void IndexVsDepth_2()
{
	...
	const Double_t MinResidualIndex = -0.08;
	const Double_t MaxResidualIndex = 0.08;
	...
	h3->GetYaxis()->SetTitle("#Delta n(z)");
	h3->GetYaxis()->SetTitleSize(0.04*scalefactor);
	h3->GetYaxis()->SetNdivisions(10,kTRUE);
	h3->Draw("");
	gPad->SetFixedAspectRatio();
	p->cd();
	...
	Moores_Bay_Hole_1_residual->SetMarkerStyle(2);
	Moores_Bay_Hole_2_residual->SetMarkerStyle(4);
	RICE_Data_residual->SetMarkerStyle(8);
	Byrd_Data_residual->SetMarkerStyle(20);
	Mizuho_Data_Fit_residual->SetMarkerStyle(21);
	SPICE_Hole_residual->SetMarkerStyle(22);
	
	Moores_Bay_Hole_1_residual->SetMarkerSize(2);
	Moores_Bay_Hole_2_residual->SetMarkerSize(2);
	SPICE_Hole_residual->SetMarkerSize(2);
	RICE_Data_residual->SetMarkerSize(2);
	Byrd_Data_residual->SetMarkerSize(1);
	Mizuho_Data_Fit_residual->SetMarkerSize(1);
	
	Moores_Bay_Hole_1_residual->SetMarkerColor(14);
	Moores_Bay_Hole_2_residual->SetMarkerColor(14);
